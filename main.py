...
from app.routes import documents, faq_ingestion, pdf_ingestion, image_ingestion, qna_ingestion, auth_routes, rag_conv, rag_router
...
app.include_router(rag_conv.router)
